...
function filterFunction() {
  ...
  <div class="col-md-12" style=" background-color: rgb(68, 66, 44);"><font size="10" color="white" face="DSN KrungKaSame"><center>เครื่องประดับ</center></font> </div>
  ...
  <?php
                try{
                    ...
                    where group_sell_id='13' order by sell_id desc limit 10");
