...
<html>
    ...
    <body>
        ...
        <table border="1px">
            ...
            ?>
            <tr>
                <td><?php echo $row_select['buy_buy_id'];  ?></td>
                <td><?php echo $row_select['buy_buy_name']; ?></td>     
                <td><a href="member_type_form_update.php?update_id=<?php echo $row_select['buy_buy_id'];  ?>"  
                onclick="return confirm('คุณเเน่ใจที่จะเเก้ไขข้อมูลใช่หรือไม่ ?');" > เเก้ไข </a></td> 
 
                <td><a href="member_type_delete.php?delete_id=<?php echo $row_select['buy_buy_id']; ?>"
