...
try{
$sql_insert = "insert into mks_sell (sell_id,sell_name,sell_type,sell_group,sell_price,sell_img,sell_details,sell_eddress,sell_tel) 
values ('','$get_name','$get_type','$get_group','$get_price','$filename','$get_details','$get_eddress','$get_tell')";
