  ...
  for (i = 0; i < a.length; i++) {
    ...
    <body>
        ...
        <div class="row"><!-- เริ่มต้น Slide Image -->
            <div class="col-md-12" style="background-color: rgb(68, 66, 44);"><h1 style="color:white"><b><font face="DSN KrungKaSame" size="10"><center>ข้อมูลการขาย</center></font></h1></div><br></b>
        ...
        <table border="1px">
            <tr>
                ...
                <th><font color="#FFFFFF">ชื่อสินค้า</font></th>
                <th><font color="#FFFFFF">ประเภทสินค้า</font></th>
                <th><font color="#FFFFFF">หมวดหมู่สินค้า</font></th>
                <th><font color="#FFFFFF">ราคา</font></th>
                <th><font color="#FFFFFF">รูปภาพ</font></th>
                <th><font color="#FFFFFF">รายละเอียดสินค้า</font></th>
                <th><font color="#FFFFFF">ที่อยู่สินค้า</font></th>
            ...
            <tr>
                <td><font color="#FFFFFF"><?php echo $row_select['sell_id'];  ?></font></td>
                <td><font color="#FFFFFF"><?php echo $row_select['sell_name']; ?></font></td> 
                <td><font color="#FFFFFF"><?php echo $row_select['type_sell_name']; ?></font></td> 
                <td><font color="#FFFFFF"><?php echo $row_select['group_sell_name']; ?></font></td>
                <td><font color="#FFFFFF"><?php echo $row_select['sell_price']; ?></td>  
                <td><font color="#FFFFFF"><img src="img/<?php echo $row_select['sell_img']; ?>"  style="width:120px" ></font></td>
                <td><font color="#FFFFFF"><?php echo $row_select['sell_details']; ?></font></td> 
                <td><font color="#FFFFFF"><?php echo $row_select['sell_eddress']; ?></font></td> 
                <td><font color="#FFFFFF"><?php echo $row_select['sell_tel']; ?></font></td> 
                <td><font color="#FFFFFF"><a href="member_form_update.php?update_id=<?php echo $row_select['sell_id'];  ?>"  
                onclick="return confirm('คุณเเน่ใจที่จะเเก้ไขข้อมูลใช่หรือไม่ ?');" > เเก้ไข </a></font></td> 
 
                <td><font color="#FFFFFF"><a href="member_delete.php?del_id=<?php echo $row_select['sell_id']; ?>"
