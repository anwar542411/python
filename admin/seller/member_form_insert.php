...
<div class="row"><!-- เริ่มต้น Slide Image -->
            <div class="col-md-12" style="background-color: rgb(68, 66, 44);"><h1 style="color:white"><b><font face="DSN KrungKaSame" size="10"><center>เเบบฟอร์มบันทึกข้อมูลการขาย</center></font></h1></div><br></b>
            ...
            <table>
                ...
                <tr>
                    ...
                    <select name="ftype">  
                        <?php
                            try{
                                $sql_select= $conn->prepare("SELECT * FROM type_sell"); 
                                $sql_select->execute();//สั่งให้ sql_select ทำงาน
                                while($row_select = $sql_select->fetch(PDO::FETCH_ASSOC)){
                                        
                        ?>
                        <option value="<?php echo $row_select['type_sell_id']; ?>"><?php echo $row_select['type_sell_name'];?></option> 
                        <?php 
                                }
                            }
                ...
                <tr>
                    ...
                    <select name="fgroup">  
                        <?php
                            try{
                                $sql_select= $conn->prepare("SELECT * FROM group_sell"); 
                                $sql_select->execute();//สั่งให้ sql_select ทำงาน
                                while($row_select = $sql_select->fetch(PDO::FETCH_ASSOC)){
                                        
                        ?>
                        <option value="<?php echo $row_select['group_sell_id']; ?>"><?php echo $row_select['group_sell_name'];?></option> 
                        <?php 
                                }
                            }
                        catch(PDOException $e) {
                ...
                <tr>
                    ...
                    <td><input type="text" name="fprice" size="50"></td>
                </tr>
                <tr>
                    <td>รูปภาพสินค้า</td>
                ...
                <tr>
                    ...
                    <td><textarea name="fdetails" rows="5" cols="50"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>เบอร์ติดต่อ</td>
                    <td><input type="text" name="ftell" size="50"></td>
                </tr>

                <tr>
                    <td></td>
                    <td><input type="submit" value="บันทึกข้อมูลการขาย"></td>
                </tr>
            </table>
        </form>
